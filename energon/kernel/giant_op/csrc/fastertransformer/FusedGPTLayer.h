...
public:
    STPGPTLayer(const IAllocator &allocator, const int batch_size,
                 const int seq_len,
                 ...
                 ) : allocator_(allocator)
    {
        ...
        // args_.vocab_size_padded_ = div_up(args_.vocab_size_, 64) * 64; //按64的倍数填充
        ...
        // embedding_kernel_transposed_padded_size = div_up(embedding_kernel_transposed_padded_size, MEM_C) * MEM_C; //按128mem_c填充

        // prevent memory misalinged address
        // logits_buf_size = (size_t)(ceil(logits_buf_size / 4.)) * 4;  // ceil ; floor()
